describe("getGeneration()", function(){
    it("should return generation data", function(){
        ...
        waitsFor(function() {
            return flag;
        }, "correct generation data should have been returned", 10000); 
    })
...
describe("getPokedex()", function(){
    it("should return pokedex data", function(){
        ...
        waitsFor(function() {
            return flag;
        }, "correct pokedex data should have been returned", 10000); 
    })
...
describe("getVersion()", function(){
    it("should return version data", function(){
        ...
        waitsFor(function() {
            return flag;
        }, "correct version data should have been returned", 10000); 
    })
...
describe("getVersionGroup()", function(){
    it("should return version group data", function(){
        ...
        waitsFor(function() {
            return flag;
        }, "correct version group data should have been returned", 10000); 
    })
