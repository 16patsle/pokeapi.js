  ...
  it('should return item data', function () {
    runs(function () {
      ...
      PokeApi.getItem(3).then(function (response) {
        if (
          response.category.name === 'standard-balls' &&
          response.name === 'great-ball'
        ) {
          flag = true;
        }
      });
    ...
    waitsFor(
      ...
      'correct item data should have been returned',
      10000
    );
  });
});
...
describe('getItemAttribute()', function () {
  it('should return item attribute data', function () {
    ...
    waitsFor(
      ...
      'correct item attribute data should have been returned',
      10000
    );
  });
});
...
describe('getItemCategory()', function () {
  it('should return item category data', function () {
    ...
    waitsFor(
      ...
      'correct item category data should have been returned',
      10000
    );
  });
});
...
describe('getItemFlingEffect()', function () {
  it('should return item fling effect data', function () {
    ...
    waitsFor(
      ...
      'correct item fling data data should have been returned',
      10000
    );
  });
});
...
describe('getItemPocket()', function () {
  it('should return item pocket data', function () {
    ...
    waitsFor(
      ...
      'correct item pocket data should have been returned',
      10000
    );
  });
});
