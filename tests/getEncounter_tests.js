describe("getEncounterMethod()", function(){
    it("should return encounter method data", function(){
        ...
        waitsFor(function() {
            return flag;
        }, "correct encounter method data should have been returned", 10000); 
    })
...
describe("getEncounterCondition()", function(){
    it("should return encounter condition data", function(){
        ...
        waitsFor(function() {
            return flag;
        }, "correct encounter condition data should have been returned", 10000); 
    })
...
describe("getEncounterConditionValue()", function(){
    it("should return encounter condition value data", function(){
        ...
        waitsFor(function() {
            return flag;
        }, "correct encounter condition value data should have been returned", 10000); 
    })
